...
const Footer = () => {
  return (
    <footer className="bg-civic-darkBlue text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-white">Civicsphere</span>
            </div>
            <p className="text-gray-300 mb-4">
              Connecting our community with the information that matters most.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/announcements" className="text-base text-gray-300 hover:text-white">
                  Announcements
                </Link>
              </li>
              <li>
                <Link to="/leaders" className="text-base text-gray-300 hover:text-white">
                  Community Leaders
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/issues" className="text-base text-gray-300 hover:text-white">
                  Issue Reporting
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col items-center">
          <p className="text-base text-gray-400">
            © 2025 Civicsphere. All rights reserved.
          </p>
